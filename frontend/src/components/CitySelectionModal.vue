...
const mainCities = [
  ...
  { key: 'hamburg', name: 'Hamburg', aliases: ['Hamburg'] },
  { key: 'frankfurt', name: 'Frankfurt', aliases: ['Frankfurt', 'Frankfurt am Main'] },
  { key: 'berlin', name: 'Berlin', aliases: ['Berlin'] },
  { key: 'dusseldorf', name: 'Düsseldorf', aliases: ['Düsseldorf', 'Duesseldorf', 'Dusseldorf'] },
]

const otherCities = [
  { key: 'stuttgart', name: 'Stuttgart', aliases: ['Stuttgart'] },
  { key: 'bonn', name: 'Bonn', aliases: ['Bonn'] },
  { key: 'cologne', name: 'Cologne', aliases: ['Köln', 'Cologne', 'Koeln'] },
  { key: 'leipzig', name: 'Leipzig', aliases: ['Leipzig'] },
  { key: 'dresden', name: 'Dresden', aliases: ['Dresden'] },
  { key: 'hannover', name: 'Hannover', aliases: ['Hannover'] },
  { key: 'nuremberg', name: 'Nuremberg', aliases: ['Nürnberg', 'Nuremberg', 'Nuernberg'] },
  { key: 'bremen', name: 'Bremen', aliases: ['Bremen'] },
  { key: 'dortmund', name: 'Dortmund', aliases: ['Dortmund'] },
  { key: 'essen', name: 'Essen', aliases: ['Essen'] },
]
